...
public class BackOfficeOperationsTestCases extends BaseTestCase {
		...
		public void testOperationTechnicianCommisionSearch() throws Exception {
			...
			Assert.assertEquals(techcommissionpage.MAX_TABLE_ROW_COUNT_VALUE, Integer.valueOf(techcommissionpage.getTechnicianCommissionsTableRowCount()));
		...
		public void testOperationServiceRequestSearch() throws Exception {
			...
			ServiceRequestsWebPage servicerequestspage = operationspage.clickServiceRequestsLink();
			servicerequestspage.verifyInvoicesTableColumnsAreVisible();
			
			
			Assert.assertEquals("1", servicerequestspage.getCurrentlySelectedPageNumber());
			Assert.assertEquals("1", servicerequestspage.getGoToPageFieldValue());
			
			servicerequestspage.setPageSize("1");
			Assert.assertEquals(1, servicerequestspage.getTechnicianCommissionsTableRowCount());
			
			String lastpagenumber = servicerequestspage.getLastPageNumber();
			servicerequestspage.clickGoToLastPage();
			//Assert.assertEquals(lastpagenumber, servicerequestspage.getGoToPageFieldValue());
			
			servicerequestspage.clickGoToFirstPage();
			Assert.assertEquals("1", servicerequestspage.getGoToPageFieldValue());
			
			servicerequestspage.clickGoToNextPage();
			Assert.assertEquals("2", servicerequestspage.getGoToPageFieldValue());
			
			servicerequestspage.clickGoToPreviousPage();
			Assert.assertEquals("1", servicerequestspage.getGoToPageFieldValue());

			servicerequestspage.setPageSize("999");
			Thread.sleep(1000);
			Assert.assertEquals(servicerequestspage.MAX_TABLE_ROW_COUNT_VALUE, Integer.valueOf(servicerequestspage.getTechnicianCommissionsTableRowCount()));
			...
			Assert.assertEquals(Integer.valueOf(1), Integer.valueOf(servicerequestspage.getTechnicianCommissionsTableRowCount()));
			servicerequestspage.verifySearchResultsByVehicleInfo("2002 Ford F-150 SDN");
		}*/
		...
		public void testOperationInspection() throws Exception {
			...
			if (Integer.valueOf(lastpagenumber) < 50) {
				Assert.assertEquals(Integer.valueOf(lastpagenumber), Integer.valueOf(inpectionspage.getInspectionsTableRowCount()));
			} else {
		...
		public void testOperationNewInspection() throws Exception {

			final String customertype= "Retail";
			final String customername= "Small Pixie";					
			
			final String VIN = "1FAFP56SX3G732276";
			final String servicename = "AMoneyFlatFee_VacuumCleaner";
			final String inspectiondescription = "test description";
			...
			newinspectionpage.setInspectionDescription(inspectiondescription);
			...
			inspectionspage.deleteFirstInspection();
			Assert.assertEquals(0, inspectionspage.getInspectionsTableRowCount());
		}*/
		
		//@Test(testName = "Test Case 24668:Operations: Automatic WO Creation after Inspection Approval (Approval required - ON)", 
		//		description = "Operations: Automatic WO Creation after Inspection Approval (Approval required - ON)")
		...
		//@Test(testName = "Test Case 24670:Operations: Automatic WO Creation after Inspection Approval (Line approval - ON)", 
		//		description = "Operations: Automatic WO Creation after Inspection Approval (Line approval - ON)")
		...
		//@Test(testName = "Test Case 24671:Operations: Automatic WO Creation after Inspection Approval (Enable Multiselect - ON)", 
		//		description = "Operations: Automatic WO Creation after Inspection Approval (Enable Multiselect - ON)")
		...
		//@Test(testName = "Test Case 24672:Operations: Automatic WO Creation after Inspection Approval (Enable Simple Approval - ON)", 
		//		description = "Operations: Automatic WO Creation after Inspection Approval (Enable Simple Approval - ON)")
		...
		//@Test(testName = "Test Case 24674:Operations: Automatic WO Creation after Inspection Approval (Approval required - OFF)", 
		//		description = "Operations: Automatic WO Creation after Inspection Approval (Approval required - OFF)")
		...
		//@Test(testName = "Test Case 24676:Operations: WO is not created after Inspection Decline (Approval required - ON)", 
		//		description = "Operations: WO is not created after Inspection Decline (Approval required - ON)")
		...
		/*public void waitForWindow(String title){
