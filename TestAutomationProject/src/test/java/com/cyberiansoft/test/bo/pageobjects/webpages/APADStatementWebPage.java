...
public class APADStatementWebPage extends BaseWebPage {
    ...
    public APADStatementWebPage selectArea(String area) {
        selectComboboxValue(areaCombobox, areaDropDown, area);
        return this;
    }

    public APADStatementWebPage selectTeam(String team) {
        selectComboboxValue(teamCombobox, teamDropDown, team);
        return this;
    }

    public APADStatementWebPage selectEmployee(String employee) {
        selectComboboxValueWithTyping(employeeTextField, employeeDropDown, employee);
        return this;
    }

    public APADStatementWebPage selectCustomer(String customer) {
        selectComboboxValueWithTyping(customerTextField, customerDropDown, customer);
        return this;
    }

    public APADStatementWebPage clickSearchButton() {
