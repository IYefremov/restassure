...
public class InvoicesWebPage extends WebPageWithFilter {
	...
	@FindBy(id = "ctl00_ctl00_Content_Main_ctl04_filterer_ddlBillingStatus_Input")
	...
	public void clickSendCustomEmail(String invoicenumber) {
		waitABit(2000);
	...
	public void clickEmailActivity(String invoicenumber) {
		waitABit(30000);
		String mainWindowHandle = driver.getWindowHandle();
	...
	public void clickEditInvoice(String invoicenumber) {
		waitABit(5000);
		String mainWindowHandle = driver.getWindowHandle();
	...
	public void clickInvoicePayments(String invoicenumber) {
		String mainWindowHandle = driver.getWindowHandle();
...
//            setAttribute(slideDisplayed, "")
	...
	public void clickEditFirstInvoice() {
	...
	public void selectSearchStatus(String s) {
		wait.until(ExpectedConditions.elementToBeClickable(searchstatuscmb.getWrappedElement())).click();
		wait.until(ExpectedConditions.elementToBeClickable((By.xpath("//li[contains(text(), '" + s + "')]")))).click();
		waitABit(1000);
	}

	public void findInvoice(WebConstants.TimeFrameValues timeframe, String status) {
	...
	public void checkPayBoxContent() {
		...
		paymentNote.findElement(By.id("ctl00_ctl00_Content_Main_ctl01_ctl01_Card_txtPoRoNumber")).sendKeys("123");
		paymentNote.findElement(By.id("ctl00_ctl00_Content_Main_ctl01_ctl01_Card_chkPoRoApprove")).click();
...
//			wait.until(ExpectedConditions.presenceOfElementLocated(By.id("ctl00_ctl00_Content_Main_ctl01_ctl00_Card_txtCashNotes")));
		...
		paymentNote.findElement(By.xpath("//input[@id='ctl00_ctl00_Content_Main_ctl01_ctl01_Card_txtCheckNumber']"));
		paymentNote.findElement(By.id("ctl00_ctl00_Content_Main_ctl01_ctl01_Card_tbCashAmount"));
		paymentNote.findElement(By.id("ctl00_ctl00_Content_Main_ctl01_ctl01_Card_txtCashNotes"));
	...
	public boolean checkInvoicesSearchFields() {
		try {
			...
			wait.until(ExpectedConditions.visibilityOf(searchtechniciancmb));
			wait.until(ExpectedConditions.visibilityOf(searchstatuscmb.getWrappedElement()));
			wait.until(ExpectedConditions.visibilityOf(searchbillingcmb));
			wait.until(ExpectedConditions.visibilityOf(searchvinfld.getWrappedElement()));
			wait.until(ExpectedConditions.visibilityOf(searchinvoicenofld.getWrappedElement()));
			wait.until(ExpectedConditions.visibilityOf(searchamountfromfld.getWrappedElement()));
			wait.until(ExpectedConditions.visibilityOf(searchamounttofld.getWrappedElement()));
			wait.until(ExpectedConditions
	...
	public void switchToExportInvoicesWindow(String mainWindow) {
