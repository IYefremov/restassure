...
public class DentWizartestCases extends BaseTestCase {
	...
	public void testTurningMultipleWorkOrdersIntoASingleInvoice()
		...
		Assert.assertTrue(myinvoicesscreen.myInvoiceExists(wo1));
		Assert.assertTrue(myinvoicesscreen.myInvoiceExists(wo2));
	...
	public void testInspectionsConvertToWorkOrder() throws Exception {
		...
		selectedservicescreen.saveSelectedServiceDetails();
		servicesscreen.clickServiceTypesButton();
		servicesscreen.assertPriceIsCorrect(PricesCalculations.getPriceRepresentation(ExcelUtils.getTotalSumm(testcaserow)));
		...
		selectedservicescreen.saveSelectedServiceDetails();
		servicesscreen.clickServiceTypesButton();
		servicesscreen.assertPriceIsCorrect(PricesCalculations.getPriceRepresentation(ExcelUtils.getTotalSumm2(testcaserow)));
	...
	public void testVehicleServiceDoesNotMultiplyPriceEnteredWhenSelectingMultiplePanels()
		...
		selectedservicescreen.saveSelectedServiceDetails();
		selectedservicescreen.saveSelectedServiceDetails();
		servicesscreen.assertPriceIsCorrect(PricesCalculations.getPriceRepresentation(ExcelUtils.getServicePrice(testcaserow)));
	...
	public void testQuickQuoteOptionForRetailHail() throws Exception {
		...
		Assert.assertEquals(
				alerttext,
				"Warning! Question 'Estimate Conditions' in section 'Hail Info' should be answered.");
		questionsscreen = new QuestionsScreen(appiumdriver);
	...
	public void testAddingNotesToWorkOrder()
		...
		myworkordersscreen.clickHomeButton();
		MyInvoicesScreen myinvoicesscreen = homescreen.clickMyInvoices();
		Assert.assertTrue(myinvoicesscreen.myInvoiceExists(ExcelUtils.getVIN(testcaserow)));
