...
public class AlertsCaptions {
	...
	public static final String ALERT_TOTAL_SALE_REQUIRED = "Warning!\nTotal Sale is required.";
	public static final String ALERT_CANNOT_CREATE_INVOICE_NOT_COMPLETED_RO = "You cannot create invoice from not completed RO";
	public static final String ALERT_CLAIM_REQUIRED = "Warning!\nClaim# is required.";
	...
	public static final String WOULD_YOU_LIKE_TO_REMOVE_SERVICE = "Would you like to remove service\n'%1$s'?";
