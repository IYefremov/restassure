...
import com.cyberiansoft.test.ios10_client.pageobjects.iosregulardevicescreens.RegularSelectWorkOrderTypeScreen;
...
public class iOSRegularSmokeTestCases extends BaseTestCase {
	...
	public void testCreatingInspectionFromServiceRequest(String url,
		...
		webdriver = WebdriverInicializator.getInstance().initWebDriver(browsertype);
		WebDriverUtils.webdriverGotoWebPage("http://reconpro-devqa.cyberianconcepts.com/Company/ServiceRequests.aspx");
		BackOfficeLoginWebPage loginpage = PageFactory.initElements(webdriver,
				BackOfficeLoginWebPage.class);
		loginpage.UserLogin(userName, userPassword);
	...
	*/
	...
	public void testRegularVerifyThatItIsPossibleToSaveAsFinalInspectionLinkedToSR() throws Exception {
		...
		Thread.sleep(2000);
		teaminspectionsscreen.selectNextScreen(RegularServicesScreen.getServicesScreenCaption());
		servicesscreen = new RegularServicesScreen(appiumdriver);
		servicesscreen.clickSaveAsFinal();
