...
// todo delete the whole class, because the same tests are present in TeamPortalUserTestCases
//public class TeamPortalClientQuotesTestCases extends BaseTestCase {
//
//    private static final String DATA_FILE = "src/test/java/com/cyberiansoft/test/inhouse/data/InHouseClientQuotes.json";
//
//    @BeforeClass()
...
//        return new Object[][]{
//                {"CompanyAutomation", "Nock for company", "Address", "Address 2", "123AB", "United States",
