...
public class AppiumUtils {
    ...
    public static void setAndroidNetworkOn() {
        switchApplicationContext(AppContexts.NATIVE_CONTEXT);
        AndroidDriver androidDriver = (AndroidDriver<MobileElement>) DriverBuilder.getInstance().getAppiumDriver();
        if (!androidDriver.getConnection().isWiFiEnabled())
            androidDriver.setConnection(new ConnectionState(ConnectionState.WIFI_MASK));
        switchApplicationContext(AppContexts.WEBVIEW_CONTEXT);
    }
