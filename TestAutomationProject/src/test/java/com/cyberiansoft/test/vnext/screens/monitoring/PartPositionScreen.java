...
@Getter
public class PartPositionScreen extends MonitorScreen {

    @FindBy(xpath = "//div[@class='pages']/div[@data-page='category']")
    private WebElement rootElement;

    @FindBy(xpath = "//div[@data-autotests-id='part-position-list']/div")
    private List<ListElement> positionsRecordsList;

    public PartPositionScreen() {
