...
public class BOOperationsData {
    ...
    @JsonProperty("tableRowCount74")
    private int tableRowCount74;
    ...
    public int getPageInt1() {
        return pageInt1;
    }

    public int getTableRowCount40() {
        return tableRowCount40;
    }

    public int getTableRowCount74() {
        return tableRowCount74;
    }
    ...
    public String getTextSearchParameter() {
